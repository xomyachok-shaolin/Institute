...
void fonts(void) {
	...
	SetBkMode(CDC, OPAQUE);
	SetTextAlign(CDC, TA_LEFT);
	TextOut(CDC, 300, 80, "Шрифт DEFAULT_GUI_FONT", 25);
	SelectObject(CDC, exhf);
	DeleteObject(hf);
	...
	SetBkMode(CDC, OPAQUE);
	SetTextAlign(CDC, TA_LEFT);
	TextOut(CDC, 300, 140, "Шрифт DEFAULT_GUI_FONT", 22);
	SelectObject(CDC, exhf);
	DeleteObject(hf);
	...
	SetBkMode(CDC, OPAQUE);
	SetTextAlign(CDC, TA_LEFT);
	TextOut(CDC, 300, 160, "Шрифт DC_BRUSH", 14);
	SelectObject(CDC, exhf);
	DeleteObject(hf);
	...
	SetBkMode(CDC, OPAQUE);
	SetTextAlign(CDC, TA_LEFT);
	TextOut(CDC, 300, 180, "Шрифт DC_PEN", 12);
	SelectObject(CDC, exhf);
	DeleteObject(hf);
